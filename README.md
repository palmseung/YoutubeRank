...
![YouTubeRank](demo/demo.gif)


## 🎈 서비스 소개
-  [link](http://3.34.222.93:8080/)
...
- 프로그램에서 발표한 경연 순위가 YouTube 영상의 조회수 순위와 굉장히(!) 많이 엇나가면서, 특정 키워드에 대해 YouTube 영상들의 순위를 한 번에 보여주는 서비스가 필요하다는 생각을 했습니다. 
